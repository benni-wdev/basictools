...
import static com.wwt.tools.basetools.graph.DFSAlgorithm.newInstance;
...
public class DFSAlgorithmTest {
    ...
    public void notFoundTest2() {
        ...
        NodeSearchAlgorithm<Integer> searchAlgorithm = newInstance();
        assertFalse(searchAlgorithm.search(g,null, null));
    }
    ...
    public void notFoundTest3() {
        ...
        NodeSearchAlgorithm<Integer> searchAlgorithm = newInstance();
        assertFalse(searchAlgorithm.search(g,1,5));
    }
    @Test
    public void notFoundTest() {
        DirectedGraph<Integer,Integer> g = createOneNodeGraph();
        NodeSearchAlgorithm<Integer> searchAlgorithm = newInstance();
        assertFalse(searchAlgorithm.search(g,1,7));
    }
